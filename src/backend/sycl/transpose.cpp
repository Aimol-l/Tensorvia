...
void TransposeImpl<Device::SYCL>::execute(const Tensor& a,Tensor& dst,std::initializer_list<int64_t> axes){
    ...
    auto& q = ctx_impl->get_queue();
    switch (a.dtype()) {
        case DataType::INT8:    transpose_sycl<int8_t>(dst,a,axes_v,q);break;
        case DataType::INT16:   transpose_sycl<int16_t>(dst,a,axes_v,q); break;
        case DataType::INT32:   transpose_sycl<int32_t>(dst,a,axes_v,q); break;
        case DataType::INT64:   transpose_sycl<int64_t>(dst,a,axes_v,q); break;
        case DataType::FLOAT16: transpose_sycl<float16>(dst,a,axes_v,q); break;
        case DataType::FLOAT32: transpose_sycl<float32>(dst,a,axes_v,q); break;
        case DataType::FLOAT64: transpose_sycl<float64>(dst,a,axes_v,q); break;
        case DataType::BFLOAT16:transpose_sycl<bfloat16>(dst,a,axes_v,q); break;
    }
}
